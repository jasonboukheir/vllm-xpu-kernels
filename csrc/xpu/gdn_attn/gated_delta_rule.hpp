...
// tokens. query_start_loc identifies its contiguous slice in LOCAL q/k/v/b/a;
// state columns retain full capacity for rollback from the previous step.
//
...
#pragma unroll
    ...
    // -- Iterate over this sequence's actual query tokens -------------------
